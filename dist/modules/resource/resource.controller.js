...
let ResourceController = class ResourceController {
    ...
    async createResources(body, etm) {
        return this.resourceService.createResource(body, etm);
    }
    async updateTemplateActiveStatus(resourceId, bodyParams, etm) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [resource_params_dto_1.CreateResourceParamsDto,
        typeorm_1.EntityManager]),
    __metadata("design:returntype", Promise)
], ResourceController.prototype, "createResources", null);
__decorate([
    common_1.Patch(':resourceId/set-active'),
    typeorm_1.Transaction(),
    __param(0, common_1.Param('resourceId', new common_1.ParseUUIDPipe())),
    __param(1, common_1.Body()),
    __param(2, typeorm_1.TransactionManager()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, resource_params_dto_1.UpdateResourceIsActiveParamsDto,
        typeorm_1.EntityManager]),
    __metadata("design:returntype", Promise)
], ResourceController.prototype, "updateTemplateActiveStatus", null);
ResourceController = __decorate([
    swagger_1.ApiTags('resources'),
